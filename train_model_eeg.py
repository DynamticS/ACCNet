...
def test(args, data, label, reproduce, subject, fold):
    ...
    test_loader = get_dataloader(args= args, data = data, label = label, batch_size = batch_size)
